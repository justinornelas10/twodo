<template>
	<Dialog
		v-model:visible="display" :modal="true" header="New Idea" pt:mask:class="backdrop-brightness-30"
		:style="{width: '38vw'}" class="!rounded-2xl">
		<template #header>
			<div class="flex flex-col">
				<span class="text-lg font-semibold">Añadir Nuevo lugar</span>
			</div>
		</template>
		<div class="grid grid-cols-2 space-y-3 w-full gap-5">
			<div class="flex flex-col  col-span-2">
				<label class="font-semibold mb-2">Nombre del lugar</label>
				<InputText
					name="name_place" placeholder="Escribe el nombre del restaurante, bar, etc." size="small" unstyled
					class="!rounded-full !bg-[#fafcff] border border-slate-200 text-slate-700 px-4 py-2 focus:!outline-primary-500" />
			</div>
			<div class="flex flex-col col-span-2">
				<label class="font-semibold mb-2">Descripción (opcional)</label>
				<TextArea
					name="description" placeholder="Añade notas o detalles sobre este lugar" :rows="3" unstyled
					class="!rounded-xl !bg-[#fafcff] border border-slate-200 text-slate-700 px-4 py-2 focus:!outline-primary-500" />
			</div>
			<div class="flex flex-col">
				<label class="font-semibold mb-2">Categoría</label>
				<Select
					v-model="selectedCategory" :options="categories" optionLabel="name" name="category" placeholder="Categoria"
					class="!h-[2.5rem] items-center !rounded-2xl !bg-[#fafcff] border !border-slate-200 text-slate-700 focus:!outline-primary-500" />
			</div>
			<div class="flex flex-col">
				<label class="font-semibold mb-2">Prioridad</label>
				<Select
					v-model="selectedPriority" :options="priorities" optionLabel="name" name="priority" placeholder="Prioridad"
					class="!h-[2.5rem] items-center !rounded-2xl !bg-[#fafcff] border !border-slate-200 text-slate-700 focus:!outline-primary-500" />
			</div>

			<div class="flex flex-col col-span-2">
				<label class="font-semibold mb-2 inline-flex items-center space-x-1">
					<i class="pi pi-map-marker" />
					<span>Ubicación</span>
				</label>
				<InputText
					name="description" placeholder="Dirección o ubicación" size="small" unstyled
					class="!rounded-full !bg-[#fafcff] border border-slate-200 text-slate-700 px-4 py-2 focus:!outline-primary-500" />
			</div>
			<div class="flex flex-col">
				<label class="font-semibold mb-2 inline-flex items-center space-x-1">
				...
				<InputText
					name="description" placeholder="1-5" size="small" unstyled
					class="!rounded-full !bg-[#fafcff] border border-slate-200 text-slate-700 px-4 py-2 focus:!outline-primary-500" />
			</div>
			<div class="flex flex-col">
				<label class="font-semibold mb-2 inline-flex items-center space-x-1">
				...
				<Select
					v-model="selectedPrice" :options="prices" optionLabel="name" name="price" placeholder="Nivel de precio"
					class="!h-[2.5rem] items-center !rounded-2xl !bg-[#fafcff] border !border-slate-200 text-slate-700 focus:!outline-primary-500" />
			</div>
			<div class="flex flex-col col-span-2">
				<label class="font-semibold mb-2 inline-flex items-center space-x-1">
					<svg
						id="Layer_1" fill="#000000" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
						viewBox="0 0 512 512" xml:space="preserve" class="size-5">
						<g>
							<g>
								<path
									d="M454.976,43.056c-3.591-3.588-9.411-3.591-13.003,0l-95.329,95.326c-3.592,3.591-3.592,9.411-0.001,13.003
			...
			C458.566,52.467,458.566,46.646,454.976,43.056z" />
						...
						<g>
							<g>
								<path
									d="M480.9,68.571c-3.592-3.589-9.412-3.589-13.003,0l-95.328,95.328c-3.59,3.592-3.59,9.412-0.001,13.003
			c1.796,1.795,4.15,2.692,6.502,2.692c2.352,0,4.706-0.897,6.502-2.692L480.9,81.573C484.491,77.982,484.491,72.161,480.9,68.571z" />
						...
						<g>
							<g>
								<path
									d="M390.969,229.548L509.307,111.21c3.591-3.592,3.591-9.412,0-13.003c-3.592-3.588-9.412-3.591-13.003,0L377.968,216.545
			...
			L256.111,318.54l22.939-25.845L431.514,428.019z" />
						...
						<g>
							<g>
								<path
									d="M427.379,16.278c-3.592-3.589-9.412-3.589-13.003,0L296.04,134.617c-18.406,18.404-24.366,45.735-15.807,69.897
			...
			c24.516,24.515,28.94,62.225,10.762,91.703c-2.344,3.801-1.617,8.737,1.722,11.702l38.888,34.516L210.131,266.737z" />
				...
				<InputText
					name="description" placeholder="Italiana, Mexicana, etc" size="small" unstyled
					class="!rounded-full !bg-[#fafcff] border border-slate-200 text-slate-700 px-4 py-2 focus:!outline-primary-500" />
			</div>
			<div class="flex flex-col">
				<label class="font-semibold mb-2 inline-flex items-center space-x-1">
				...
				<InputText
					name="description" placeholder="https://..." size="small" unstyled
					class="!rounded-full !bg-[#fafcff] border border-slate-200 text-slate-700 px-4 py-2 focus:!outline-primary-500" />
			</div>
			<div class="flex flex-col">
				<label class="font-semibold mb-2 inline-flex items-center space-x-1">
				...
				<InputText
					name="description" placeholder="+ 1 234 567 8900" size="small" unstyled
					class="!rounded-full !bg-[#fafcff] border border-slate-200 text-slate-700 px-4 py-2 focus:!outline-primary-500" />
			</div>
		</div>
		<template #footer>
			<button class="btn-hover px-4 py-2 rounded-2xl border border-slate-200 hover:bg-primary-100" @click="closeModal">
				<span class="text-sm font-semibold">Cancel</span>
			</button>
			<button class="btn-hover bg-primary-500 px-4 py-2 rounded-2xl border border-slate-200">
				<span class="text-white text-sm font-semibold">Añadir a Lista de Deseos</span>
			</button>
		</template>
	</Dialog>
</template>
...
const categories = ref([
    { name: 'Cita', code: 'Ci' },
    { name: 'Aniversario', code: 'An' },
    { name: 'Viaje', code: 'Vi' },
    { name: 'Cita Médica', code: 'CiMe' },
    { name: 'Recordatorio', code: 'Re' }
]);
